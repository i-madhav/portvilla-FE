...
export function KeyValue({ label, value }: { label: string; value: ReactNode }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '0.75rem', padding: '0.2rem 0' }}>
      <span style={{ color: COLORS.mutedText, fontSize: '0.75rem', minWidth: '6.5rem', flexShrink: 0 }}>
        {label}
      </span>
      <span style={{ color: COLORS.primaryText, fontSize: '0.8rem', wordBreak: 'break-word' }}>
        {value}
      </span>
    </div>
  );
